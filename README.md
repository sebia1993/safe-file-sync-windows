...
작업 DB·Unicode Robocopy 로그·HTML 보고서는 `%LOCALAPPDATA%\SafeFileSync`에 저장합니다. 이 위치가 원본/목적지와 겹치면 작업을 차단합니다. 이력은 최근 100개 작업, 화면은 차이 항목을 우선한 최대 1,000개 항목을 표시합니다. 전체 결과는 HTML 보고서에 포함됩니다.
