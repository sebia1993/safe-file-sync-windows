...
목적지의 `.safefilesync-<작업 ID>`는 재개용 임시 영역입니다. 취소된 복사본, Unicode Robocopy 로그와 빈 작업 폴더를 보존하며 자동으로 재귀 삭제하지 않습니다. 더 이상 재개하지 않을 작업의 임시 폴더는 작업 종료 후 사용자가 확인하여 정리할 수 있습니다. 현재 작업의 임시 영역만 해당 작업의 비교 결과에서 제외합니다.
